...
DJANGO_SETTINGS_MODULE=niamoto_portal.settings.local    # which settings file should Django use (*)
DJANGO_WSGI_MODULE=niamoto_portal.wsgi_local            # WSGI module name (*)
